...
When a function is created, a keyword called <span style="color:blue">some *blue* text</span>. ` this ` is created (behind the scenes), which links to the object in which the function operates.
