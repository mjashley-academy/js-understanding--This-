...
When a function is created, a keyword called $\color #c7254e Hi $ <span style="color:#c7254e">` this `</span> is created (behind the scenes), which links to the object in which the function operates.
